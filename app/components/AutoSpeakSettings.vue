<template>
    <div class="w-full space-y-4">
        ...
        <div v-if="localEnabled" class="ml-8 space-y-2">
            ...
            >
                <option value="hour">Hora fechada (a cada hora)</option>
                <option value="half-hour">A cada meia hora</option>
                <option value="quarter">Quarto de hora (a cada 15 minutos)</option>
                <option value="ten-minutes">1/6 de hora (a cada 10 minutos)</option>
                <option value="even-hours">Horas pares</option>
                <option value="odd-hours">Horas ímpares</option>
            </select>
